...
<div class="content-wrapper">
   ...
   <section class="content-header" >
      ...
      <ol class="breadcrumb" >
         <li class="active"><a href="javascript:void(0);" ><i class="fa fa-home"></i> Pendaftaran Siswa Baru</a></li>
      </ol>
   </section>
   <style type="text/css">
         ...
         <div class="col-sm-12">
            <div class="nav-tabs-custom">
               <ul class="nav nav-tabs">
                  <li class="active"><a href="#tab_0" data-toggle="tab">Formulir Pendaftaran <?php if($siswa->result()[0]->pasFoto != NULL){echo '<i class="glyphicon glyphicon-ok"></i>';}?></a> </li>
                  ...
                  <li><a href="#tab_5" data-toggle="tab">Informasi Tambahan (Wajib) <?php if($siswa->result()[0]->pertanyaan1 != NULL){echo '<i class="glyphicon glyphicon-ok"></i>';}?></a></li>
               </ul>
               <div class="tab-content">
                  <div class="tab-pane active" id="tab_0">
                     <form method="POST" action="<?=base_url()?>Welcome/save/pendaftaran" enctype="multipart/form-data">
                        ...
                        <div class="row" data-step="3" data-intro="Selanjutnya adalah Isian mengenai Informasi Ayah atau Wali. Apabila Ayah atau Wali tidak bekerja, isi dengan tanda '-' Pada kolom isian" data-position='right'>
                           ...
                           <div class="form-group col-sm-3">
                              ...
                              if($siswa->result()[0]->ayah_tanggalLahir != NULL){
                                 ?><input type="text" name="ayah_tanggalLahir" value="<?=date('d/m/Y',strtotime($siswa->result()[0]->ayah_tanggalLahir))?>" id="ayah_tanggalLahir" class="form-control datepicker" required><?php
                              }else{
                                 ?><input type="text" name="ayah_tanggalLahir" id="ayah_tanggalLahir" class="form-control datepicker" required><?php
                              }
                              ?>
                           </div>
                           <div class="form-group col-sm-3">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-sm-3">
                              <label>Kode POS</label>
                              <input type="number" onkeypress="return isNumber(event)" maxlength="6" value="<?=$siswa->result()[0]->ayah_pos?>" name="ayah_pos" placeholder="Kode Pos" class="form-control" required>
                           </div>
                        </div>
                        <div class="row">
                           <div class="form-group col-sm-3">
                        ...
                        <div class="row">
                           <div class="form-group col-sm-6">
                              ...
                              <input type="text" name="ayah_alamatKantor" value="<?=$siswa->result()[0]->ayah_alamatKantor?>" placeholder="Jalan, Kota" class="form-control" >
                           </div>
                           <div class="form-group col-sm-3">
                              <label>Jabatan</label>
                        ...
                        <!-- <?php var_dump($siswa->result()[0]->isWali)?> -->
                        <!-- <div class="row"> -->
                        <input type="checkbox" name="wali_c" id="c_wali" <?php if($siswa->result()[0]->isWali != 0){echo 'checked="true"';} ?>> Mempunyai Wali selain orang tua.
                        <!-- </div> -->
                        <div id="wali_c">
                           ...
                           <div class="row" >
                              <div class="form-group col-sm-6">
                                 ...
                                 <input type="text" name="wali_namaLengkap" value="<?=$siswa->result()[0]->wali_namaLengkap?>" placeholder="Nama Lengkap" class="form-control" >
                              </div>
                              <div class="form-group col-sm-3">
                                 <label>Tanggal Lahir</label>
                                 <?php
                                    if($siswa->result()[0]->ayah_tanggalLahir != NULL){
                                       ?><input type="text" name="wali_tanggalLahir" value="<?=date('d/m/Y',strtotime($siswa->result()[0]->wali_tanggalLahir))?>" id="wali_tanggalLahir" class="form-control datepicker" ><?php
                                    }else{
                                       ?><input type="text" name="wali_tanggalLahir" id="wali_tanggalLahir" class="form-control datepicker" ><?php
                                    }
                                    ?>
                              </div>
                              <div class="form-group col-sm-3">
                                 <label>Tempat Lahir</label>
                                 <input type="text" name="wali_tempatLahir" value="<?=$siswa->result()[0]->wali_tempatLahir?>" placeholder="Kota/Kabupaten" class="form-control" >
                              </div>
                           </div>
                           <div class="row">
                              <div class="form-group col-sm-7">
                                 <label>Alamat Rumah Wali</label>
                                 <input type="text" name="wali_alamat" value="<?=$siswa->result()[0]->wali_alamat?>" placeholder="Jalan, Kota" class="form-control" >
                              </div>
                              <div class="form-group col-sm-2">
                                 <label>Nomor HP</label>
                                 <input type="number" onkeypress="return isNumber(event)" value="<?=$siswa->result()[0]->wali_phone?>" name="wali_phone" class="form-control" >
                              </div>
                              <div class="form-group col-sm-3">
                           ...
                           <div class="row">
                              <div class="form-group col-sm-3">
                                 <label>Alamat Email</label>
                                 <input type="email" name="wali_email" placeholder="Alamat Email" value="<?=$siswa->result()[0]->wali_email?>" class="form-control" >
                              </div>
                              <div class="form-group col-sm-3">
                                 <label>Kewarganegaraan</label>
                                 <select name="wali_kewarganegaraan" id="wali_kewarganegaraan" class="form-control">
                                    <option disabled selected>-- PILIH --</option>
                              ...
                              <div class="form-group col-sm-3">
                                 <label>Suku</label>
                                 <input type="text" name="wali_suku" value="<?=$siswa->result()[0]->wali_suku?>" class="form-control"  placeholder="Suku">
                              </div>
                              <div class="form-group col-sm-3">
                                 <label>Kode POS</label>
                           ...
                           <div class="row">
                              <div class="form-group col-sm-3">
                                 <label>Pendidikan Terakhir</label>
                                 <select name="wali_lastDegree" id="wali_lastDegree" class="form-control" >
                                    <option disabled selected>-- PILIH --</option>
                              ...
                              <div class="form-group col-sm-3">
                                 <label>Jurusan/Program Studi</label>
                                 <input type="text" name="wali_jurusan" value="<?=$siswa->result()[0]->wali_jurusan?>" class="form-control" placeholder="Jurusan/Program Studi" >
                              </div>
                              <div class="form-group col-sm-3">
                                 <label>Bidang Pekerjaan</label>
                                 <input type="text" name="wali_bidKerjaan" value="<?=$siswa->result()[0]->wali_bidKerjaan?>" class="form-control" >
                              </div>
                           </div>
                           <div class="row">
                              <div class="form-group col-sm-6">
                           ...
                           <div class="row">
                              <div class="form-group col-sm-3">
                                 <label>Jumlah Jam Kerja </label>
                                 <input type="number" onkeypress="return isNumber(event)" value="<?=$siswa->result()[0]->wali_jmlJamKerja?>" name="wali_jmlJamKerja" class="form-control" placeholder="dalam Sepekan" >
                              </div>
                              <div class="form-group col-sm-3">
                                 <label>Waktu Untuk Keluarga</label>
                                 <input type="number" value="<?=$siswa->result()[0]->wali_jmlJamKeluarga?>" name="wali_jmlJamKeluarga" class="form-control" >
                              </div>
                              <div class="form-group col-sm-3">
                                 <label>NIK wali</label>
                                 <input type="number" onkeypress="return isNumber(event)" value="<?=$siswa->result()[0]->wali_nik?>" name="wali_nik" placeholder="Nomor Induk Kependudukan" class="form-control" >
                              </div>
                              <div class="form-group col-sm-3">
                                 <label>Penghasilan per Bulan</label>
                                 <select class="form-control" name="wali_penghasilan" id="wali_penghasilan" >
                                    <option selected disabled>--Pilih--</option>
                  ...
                  <div class="tab-pane" id="tab_1">
                     ...
                     <form method="POST" action="<?=base_url()?>Welcome/save/penyakit">
                        <div class="row">
                  ...
                  <div class="tab-pane" id="tab_2">
                     ...
                     <form action="<?=base_url()?>Welcome/save/kelahiran" method="POST">
                        <ol>
                           <li>
                  ...
                  <div class="tab-pane" id="tab_4">
                     ...
                     <form action="<?=base_url()?>Welcome/save/perkembangan" method="POST">
                  ...
                  <div class="tab-pane" id="tab_5">
                     ...
                     <form method="POST" action="<?=base_url()?>Welcome/save/tambahan">
                        <div class="row">
                           <div class="form-group col-md-6">
                              <label>Kami mendapat informasi tentang Sekolah Alam Indonesia dari : </label>
                              <textarea class="form-control" rows="2" name="pertanyaan1" id="pertanyaan1" required><?=$siswa->result()[0]->pertanyaan1?></textarea>
                           </div>
                           <div class="form-group col-md-6">
                              <label>Alasan kami memilih Sekolah Alam Indonesia adalah : </label>
                              <textarea class="form-control" rows="2" name="pertanyaan12" id="pertanyaan12" required><?=$siswa->result()[0]->pertanyaan1?></textarea>
                           </div>
                        </div>
                        <div class="row">
                           <div class="form-group col-md-6">
                              <label>Menurut kami, urutan skala prioritas dari akademik, akhlak, dan kepemimpinan adalah (Jelaskan!)</label>
                              <textarea class="form-control" rows="2" name="pertanyaan2" required id="pertanyaan2"><?=$siswa->result()[0]->pertanyaan2?></textarea>
                           </div>
                           <div class="form-group col-md-6">
                              <label>Menurut kami, tanggung jawab pendidikan anak ada pada (Jelaskan!)</label>
                              <textarea class="form-control" rows="3" name="pertanyaan3" required id="pertanyaan3"><?=$siswa->result()[0]->pertanyaan3?></textarea>
                           </div>
                        </div>
                        <div class="row">
                           <div class="form-group col-md-4">
                              <label>Harapan kami terhadap akhlaq anak kami ketika lulus dari Sekolah Alam Indonesia adalah</label>
                              <textarea class="form-control" rows="1" name="pertanyaan4" required id="pertanyaan4"><?=$siswa->result()[0]->pertanyaan4?></textarea>
                           </div>
                           <div class="form-group col-md-4">
                              <label>Harapan kami terhadap karakter kepemimpinan anak kami ketika lulus dari Sekolah Alam Indonesia adalah</label>
                              <textarea class="form-control" rows="2" name="pertanyaan5" required id="pertanyaan5"><?=$siswa->result()[0]->pertanyaan5?></textarea>
                           </div>
                           <div class="form-group col-md-4">
                              <label>Harapan kami terhadap kemampuan akademik anak kami ketika lulus dari Sekolah Alam Indonesia adalah</label>
                              <textarea class="form-control" rows="2" name="pertanyaan6" required id="pertanyaan6"><?=$siswa->result()[0]->pertanyaan6?></textarea>
                           </div>
                        </div>
                        <div class="row">
                           <div class="form-group col-md-4">
                              <label>Jika kami sebagai orang tua mengalami kesulitan dalam pembiayaan sekolah, maka yang akan kami lakukan adalah</label>
                              <textarea class="form-control" rows="2" name="pertanyaan7" required id="pertanyaan7"><?=$siswa->result()[0]->pertanyaan7?></textarea>
                           </div>
                           <div class="form-group col-md-4">
                              <label>Pandangan kami tentang sekolah berbasis komunitas adalah</label>
                              <textarea class="form-control" rows="2" name="pertanyaan8" required id="pertanyaan8"><?=$siswa->result()[0]->pertanyaan8?></textarea>
                           </div>
                           <div class="form-group col-md-4">
                              <label>Kontribusi konkrit yang akan kami berikan sebagai bagian dari komunitas adalah</label>
                              <textarea class="form-control" rows="2" name="pertanyaan9" required id="pertanyaan9"><?=$siswa->result()[0]->pertanyaan9?></textarea>
                           </div>
                        </div>
                        <div class="row">
                           <div class="form-group col-md-6">
                              ...
                              <textarea class="form-control" rows="3" name="pertanyaan10" required id="pertanyaan10"><?=$siswa->result()[0]->pertanyaan10?></textarea>
                           </div>
                           <div class="form-group col-md-6">
                              ...
                              <textarea class="form-control" rows="3" name="pertanyaan11" required id="pertanyaan11"><?=$siswa->result()[0]->pertanyaan11?></textarea>
                           </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-8">
                              <label>Kerja sama kami sebagai orang tua dengan guru dalam mendukung kegiatan belajar mengajar adalah</label>
                  ...
                  <div class="tab-pane" id="tab_3">
                     ...
                     <form method="POST" action="<?=base_url()?>Welcome/save/keluarga">
                        <div class="row">
                           <!-- <div class="form-group col-sm-4">
